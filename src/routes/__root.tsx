        ...
        <WishlistProvider>
          <CartProvider>
            ...
            <button
              ...
              className="fixed bottom-[84px] right-5 z-30 size-12 rounded-full border border-[rgba(255,255,255,0.2)] bg-black/50 backdrop-blur-md text-white flex items-center justify-center hover:border-white hover:bg-white hover:text-black transition-all duration-300"
            >

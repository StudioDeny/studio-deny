...
export function Preloader() {
  ...
  /* ─── Fetch Admin CMS Preloader Config ─── */
  useEffect(() => {
    (async () => {
      try {
      ...
      <AnimatePresence>
        {loading && (
          <motion.div
            ...
            className="fixed inset-0 z-[10000] bg-[#E2E2E4] flex items-center justify-center pointer-events-none select-none"
          >
            {configLoaded && (
              <div className="relative z-10 flex flex-col items-center gap-4">
                {isTextContent ? (
                  <span
                    className="text-display text-[clamp(2.5rem,8vw,5rem)] uppercase tracking-tight font-black"
            ...
            <>
              ...
              <div className="relative z-10 flex flex-col items-center justify-center px-6 max-w-3xl text-center">
                ...
                >
                  ...
                  {/* Minimalist Line Loading Indicator */}
